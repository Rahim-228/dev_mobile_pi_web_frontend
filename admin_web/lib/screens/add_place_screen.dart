...
class _AddPlaceScreenState extends State<AddPlaceScreen> {
  ...
  Future<void> _save() async {
    ...
    final result = await ApiService.createPlace(place, imageBytes: _imageBytes, imageName: _imageName);
    if (mounted) {
      setState(() => _loading = false);
      if (result != null) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: const Text('Lieu ajouté avec succès'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Erreur: ${ApiService.lastError ?? "Échec de la création"}'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ajouter un lieu', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
                  ...
                  child: _imageBytes != null
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Text('Cliquez pour ajouter une image', style: TextStyle(color: Colors.grey[500], fontSize: 15)),
                          ],
                        ),
                ),
              ),
